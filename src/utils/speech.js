      ...
      this.recognition.onresult = (event) => {
        ...
        for (let i = event.resultIndex; i < event.results.length; ++i) {
          ...
          if (r.isFinal) {
            ...
            for (let a = 1; a < r.length; a++) alternatives.push(r[a].transcript);
          } else {
        ...
        if (onResult) onResult(final || interim, { final: !!final, alternatives });
      };
...
/** App language code → BCP-47 recognizer locale (Indian variants). */
