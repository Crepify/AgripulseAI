...
export const CHATBOT_KB = [
  ...
  { keywords: ['weather', 'मौसम', 'बारिश', 'rain', 'spray'], answer: 'Weather auto-detects your village! Weather tab shows safe spray window (6:30-10:30 AM). If rain in 3h, we notify "Don\'t spray today". Check 7-day IMD forecast.', answerHi: 'मौसम आपके गांव का ऑटो-डिटेक्ट होता है! मौसम टैब में सुरक्षित छिड़काव समय (सुबह 6:30-10:30) दिखता है। 3 घंटे में बारिश हो तो "आज छिड़काव न करें" नोटिफिकेशन।' },
